...
<html lang="en">
  ...
  <body>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <form action="{{ route('uploadIzinSirtu')}}" class="formSurat shadow container" method="post">
                    @csrf
                    <div class="container">
                        <h4 class="text-start" style="font-weight:600;">Surat Rekomendasi Teknis  Izin Galian C</h4>
                    </div>
                    ...
                    <div class="container-fluid fontKecil">
                        ...
                        <div class="form-group mr-3 pr-3">
                            <input type="text" id="koordinat" name="koordinat" class="form-control" placeholder="Titik Koordinat Pemanfaatan" value="Sesuai Lampiran I dan II Keputusan Kepala Dinas Penanaman Modal dan Pelayanan Terpadu Satu Pintu  Aceh Nomor : 540/DPMPTSP/1935/IUP-OP./2020 Tanggal 09 Juli 2020" required>
                        </div>
                    </div>
