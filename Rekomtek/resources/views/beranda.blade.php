...
<html lang="en">
  ...
  <body>
        ...
        <nav id="sidebar" >
            ...
            <ul class="list-unstyled components ">
                <li class="active margin">
                    <a href="/beranda" aria-expanded="false" class="" style="color: #152831;"><img src="/image/home_work-active.png" alt="">  Beranda</a>
                </li>
                <li>
        ...
        <div id="content">
            ...
            <h3 class="text-center fontSurat" style="font-weight: 600;">Beranda Rekomendasi Teknis <br> Dinas Pengairan Banda Aceh</h3>
                ...
                <div class="row gy-5 justify-content-center">
                    <div class="col-md-4 my-5">
                        <a href="/arsipair"><div class="card1">
                            ...
                            <div class="card-body text-start">
                                <h3 class="fontSurat" style="font-size:22px; font-weight: 600; text-align:start;">RekomTek Air</h3>
                                <div class="align-items-start mt-3">
                                    <img src="/image/pin.png" alt="">Jumlah Surat Air : {{$countAir}}</a>
                                </div>
                            </div>
                        </div></a>
                    </div>
                    <div class="col-md-4 my-5">
                        <a href="/arsipsirtu"><div class="card1">
                            ...
                            <div class="card-body text-start">
                                <h3 class="fontSurat" style="font-size:22px; font-weight: 600; text-align:start;">RekomTek Galian-C</h3>
                                <div class="align-items-start mt-3">
                                    <img src="/image/pin.png" alt="">Jumlah Surat Galian-C : {{$countSirtu}}</a>
                                </div>
                            </div>
                        </div></a>
                    </div>
