            ...
            <div class="container-fluid">
                ...
                <form action="" class="formSurat shadow container" method="post">
                    ...
                    <div class="container">
                        ...
                        <h4 class="text-center" style="font-weight:600;">Surat Rekomendasi Teknis Perpanjangan Izin Pengelolaan Galian-C </h4>
                    </div>
                    ...
                    <div class="container-fluid fontKecil">
                        ...
                        <p class="pb-0 mb-0 pt-1 text-dark font-weight-bold" style="font-size:13px;">Izin yang telah dimiliki	:</p>
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group mr-3 pr-3 mb-1">
                                    <p class="form-control border-0">{{$data->tgl_izin_lama}}</p>
                                </div>
                            </div>
                            <div class="col">
