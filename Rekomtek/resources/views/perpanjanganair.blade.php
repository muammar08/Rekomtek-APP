...
<html lang="en">
  ...
  <body>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <form action="{{ route('uploadPjAir')}}" class="formSurat shadow container" method="post">
                    @csrf
                    <div class="container">
                        <h4 class="text-start" style="font-weight:600;">Surat Rekomendasi Teknis Perpanjangan Izin Pengelolaan Air </h4>
                    </div>
                    ...
                    <div class="container-fluid fontKecil">
                        ...
                        <p class="pb-0 mb-0">Volume Yang Diizinkan</p>  
                        <div class="form-group mr-3 pr-3">
                            <input type="text" id="volume_izin" name="volume_izin" class="form-control" placeholder="Volume Yang Diizinkan" value=".....  M3/Jam" required>
                        </div>
                    </div>
