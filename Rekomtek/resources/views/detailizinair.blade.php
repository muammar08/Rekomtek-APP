            ...
            <div class="container-fluid">
                ...
                <form action="" class="formSurat shadow container" method="post">
                    ...
                    <div class="container">
                        ...
                        <h4 class="text-center" style="font-weight:600;">Surat Rekomendasi Teknis Permohonan Izin Pengelolaan Air </h4>
                    </div>
                    ...
                    <div class="row justify-content-between fontKecil container ">
                        <div class="col">
                            ...
                            <div class="form-group ">
                                <p class="form-control border-0">{{$data->surat_permohonan2}}</p>
                            </div>
                        </div>
                        <div class="col">
                            <p class="pb-0 mb-0">Tanggal Permohonan</p> 
                            <div class="form-group ">
                                <p class="form-control border-0">{{$data->tgl_permohonan2}}</p>
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid fontKecil ">
                        ...
                        <div class="form-group mr-3 pr-3">
                            <p class="form-control border-0">{{$data->perihal_permohonan2}}</p>
                        </div>
                    </div>
