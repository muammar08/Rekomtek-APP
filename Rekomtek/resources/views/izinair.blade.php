...
<html lang="en">
  ...
  <body>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <form action="{{ route('uploadIzinAir')}}" class="formSurat shadow container" method="post">
                    @csrf
                    <div class="container">
                        <h4 class="text-start" style="font-weight:600;">Surat Rekomendasi Teknis  Izin Pengelolaan Air </h4>
                    </div>
                    ...
                    <div class="row justify-content-between fontKecil container ">
                        <div class="col">
                            ...
                            <div class="form-group ">
                                <input type="text" id="surat_permohonan" name="surat_permohonan" class="form-control" placeholder="Nomor Surat Permohonan" value="691/DPMPTSP/1472/2022" required>
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <div class="container-fluid fontKecil ">
                        ...
                        <div class="form-group mr-3 pr-3">
                            <input type="text" id="perihal_permohonan" name="perihal_permohonan" class="form-control" placeholder="Perihal Permohonan" value="Permohonan Rekomendasi Teknis Pengusahaan Sumber Daya Air" required>
                        </div>
                    </div>
                    <div class="row justify-content-between fontKecil container ">
                        <div class="col">
                            <p class="pb-0 mb-0">Nomor Surat Pengantar</p>  
                            <div class="form-group ">
                                <input type="text" id="surat_permohonan2" name="surat_permohonan2" class="form-control" placeholder="Nomor Surat Pengantar" value="691/DPMPTSP/1557/2022" required>
                            </div>
                        </div>
                        <div class="col">
                            <p class="pb-0 mb-0">Tanggal Permohonan</p> 
                            <div class="form-group ">
                                <input type="date" id="tgl_permohonan2" name="tgl_permohonan2" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid fontKecil ">
                        <p class="pb-0 mb-0">Perihal  Surat Pengantar</p>  
                        <div class="form-group mr-3 pr-3">
                            <input type="text" id="perihal_permohonan2" name="perihal_permohonan2" class="form-control" placeholder="Perihal  Surat Pengantar" value="Permintaan Tenaga Teknis untuk Peninjauan " required>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid fontKecil">
                        <p class="pb-0 mb-0">Sumber Air</p>  
                        <div class="form-group mr-3 pr-3 mb-1">
                            <input type="text" id="sumber_air" name="sumber_air" class="form-control" placeholder="Sumber Air" value="Sungai Krueng Jreu" required>
                        </div>
                        <p class="pb-0 mb-0">Wilayah Sungai</p>  
                        <div class="form-group mr-3 pr-3 mb-1">
                            <input type="text" id="wilayah_sungai" name="wilayah_sungai" class="form-control" placeholder="Wilayah Sungai" value="Tamiang - Langsa (01.06.B)" required>
                        </div>
                        <div class="">
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="form-group mr-3 pr-3 mb-1">
                                    <input type="text" id="desa" name="desa" class="form-control" placeholder="Kelurahan/Desa" value="Gani" required>
                                </div>
                                </div>
                                <div class="col">
                                <p class="pb-0 mb-0">Kecamatan</p>  
                                <div class="form-group mr-3 pr-3 mb-1">
                                    <input type="text" id="kecamatan" name="kecamatan" class="form-control" placeholder="Kecamatan" value="Ingin jaya" required>
                                </div>
                                </div>
                                <div class="w-100"></div>
                                <div class="col">
                                ...
                                <div class="form-group mr-3 pr-3 mb-1">
                                    <input type="text" id="kabupaten" name="kabupaten" class="form-control" placeholder="Kota/Kabupaten" value="Aceh Besar" required>
                                </div>
                                </div>
                                <div class="col">
                        ...
                        <div class="form-group mr-3 pr-3">
                            <input type="text" id="koordinat" name="koordinat" class="form-control" placeholder="Titik Koordinat Pengambilan Air" value="4° 13' 37.90' N   98° 03' 21.50' E" required>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid fontKecil">
                        ...
                        <div class="form-group mr-3 pr-3 mb-1">
                            <input type="text" id="tujuan" name="tujuan" class="form-control" placeholder="Tujuan Pengusahaan" value="Sungai Krueng Jreu" required>
                        </div>
                        <div class="">
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="form-group mr-3 pr-3 mb-1">
                                    <input type="text" id="pengambilan" name="pengambilan" class="form-control" placeholder="Cara Pengambilan" value="Pemompaan" required>
                                </div>
                                </div>
                                <div class="col">
                    ...
                    <p class="fontSub container text-dark mt-1 mb-2 pt-2" style="font-weight:600;">Bagian Data Verivikasi</p>
                    <div class="container-fluid fontKecil">
                        <div class="">
                            <div class="row">
                                <div class="col">
