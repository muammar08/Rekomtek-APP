            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="row">
                        <div class="btn col  mt-3 ">
                            ...
                            <a href="{{url('/downloadpdf',$datas->pdf)}}"><button type="submit" class="btn btn-danger pr-4 pl-4 mr-4 mt-3">PDF</button></a>
                            <a href="{{url('/downloadword',$datas->word)}}"><button type="submit" class="btn btn-primary pr-3 pl-3 mr-4 mt-3">WORD</button></a>
                        </div>
                ...
                <form action="" class="formSurat shadow container" method="post">
                    ...
                    <div class="container">
                        ...
                        <h4 class="text-center" style="font-weight:600;">Surat Rekomendasi Teknis Perpanjangan Izin Pengelolaan Air </h4>
                    </div>
                    ...
                    <div class="container-fluid fontKecil">
                        ...
                        <div class="form-group mr-3 pr-3 mb-1">
                            <p class="form-control border-0">{{$data->sumber_air}}</p>
                        </div>
                    ...
                    <div class="container-fluid fontKecil">
                        ...
                        <p class="pb-0 mb-0 pt-2 text-dark font-weight-bold" style="font-size:13px;">Izin yang telah dimiliki	:</p>
                        <div class="row">
                            <div class="col">
                                <p class="pb-0 mb-0">Nomor dan Tanggal Izin</p>  
                                <div class="form-group mr-3 pr-3 mb-1">
                                    <p class="form-control border-0">{{$data->nomor_izin_lama}}</p>
                                </div>
                                </div>
                                <div class="col">
                                <p class="pb-0 mb-0">Masa Berlaku Izin</p>  
                                <div class="form-group mr-3 pr-3 mb-1">
                                    <p class="form-control border-0">{{$data->masa_izin_lama}}</p>
                                </div>
                            </div>
                        </div>
                        <p class="pb-0 mb-0">Volume Yang Diizinkan</p>  
                        <div class="form-group mr-3 pr-3">
                            <p class="form-control border-0">{{$data->volume_izin}}</p>
                        </div>
                    </div>
