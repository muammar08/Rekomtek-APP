...
class SuratSirtuController extends Controller
{

    public function pageIzinSirtu(){
        
        return view('izinsirtu');
    }

    public function izinSirtu(Request $request){
        ...
        $template->setValues([
           ...
           'tgl_terima'            => $dateMasehi4,
           'nama'                  => $request->nama,
           'pekerjaan'             => $request->pekerjaan,
           'alamat'                => $request->alamat,
           'nama_pt'               => $request->nama_pt,
           'sumber_sirtu'          => $request->sumber_sirtu,
        ...
        $fileName = 'word/'.time().'-'.$request->nama.'-'.'Permohonan-Galian-C'.'.'.'docx';
  
        $template->saveAs($fileName);
  
        $filename = time().'-'.$request->nama.'-'.'Permohonan-Galian-C'.'.'.'docx';
      ...
      $clientId="c7b3886d-6922-4e57-8c83-62c3098acf1c";
        ...
        copy($result->getPathName(),'pdf/'.time().'-'.$request->nama.'-'.'Permohonan-Galian-C'.'.'.'pdf');
        print_r($result->getPathName());
        $pdfName = time().'-'.$request->nama.'-'.'Permohonan-Galian-C'.'.'.'pdf';
        ...
        SuratSirtu::create([
           ...
           'type'                  => 'Permohonan Izin Galian-C',
           'word'                  => $filename,
           'pdf'                   => $pdfName
        ]);
  
        $this->bapIzinSirtu($request);
  
  
        return redirect()->back();
    }

    public function bapIzinSirtu(Request $request){
        ...
        $template = new \PhpOffice\PhpWord\TemplateProcessor('template/bap_rekomtek_galian-c.docx');
        ...
        $fileName = 'word/'.time().'-'.$request->nama.'-'.'BAP-Permohonan-Galian-C'.'.'.'docx';
  
        $template->saveAs($fileName);
  
        $filename = time().'-'.$request->nama.'-'.'BAP-Permohonan-Galian-C'.'.'.'docx';
      ...
      $clientId="c7b3886d-6922-4e57-8c83-62c3098acf1c";
        ...
        $aspose = new \Aspose\Words\Model\Requests\ConvertDocumentRequest($file, $format,null);
        $result = $wordsApi->ConvertDocument($aspose);	
        copy($result->getPathName(),'pdf/'.time().'-'.$request->nama.'-'.'BAP-Permohonan-Galian-C'.'.'.'pdf');
        print_r($result->getPathName());
        $pdfName = time().'-'.$request->nama.'-'.'BAP-Permohonan-Galian-C'.'.'.'pdf';
  
        BAP::create([
           'no_berita_acara'       => $request->no_berita_acara,
           'tgl_berita_acara'      => $request->tgl_berita_acara,
           'nama_pt'               => $request->nama_pt,
           'type'                  => 'BAP Permohonan Izin Galian-C',
           'word_bap'              => $filename,
           'pdf_bap'               => $pdfName
        ]);
    ...
    public function pagePerpanjanganSirtu(){
   	
        return view('perpanjangansirtu');
    }
    
    public function perpanjanganSirtu(Request $request){
        ...
        $template = new \PhpOffice\PhpWord\TemplateProcessor('template/perpanjangan_galian-c.docx');
        ...
        $date3 = $request->tgl_berita_acara;
        $date4 = $request->tgl_terima;
        $date5 = $request->tgl_izin_lama;
        $date6 = $request->masa_izin_lama;
        ...
        $dateMasehi3 = Carbon::createFromFormat('Y-m-d', $date3)->format('d F Y');
        $dateMasehi4 = Carbon::createFromFormat('Y-m-d', $date4)->format('d F Y');
        $dateMasehi5 = Carbon::createFromFormat('Y-m-d', $date5)->format('d F Y');
        $dateMasehi6 = Carbon::createFromFormat('Y-m-d', $date6)->format('d F Y');
        ...
        $template->setValues([
           ...
           'tanggal_izin_lama'     => $dateMasehi5,
           'masa_izin_lama'        => $dateMasehi6,
           'no_berita_peninjauan'  => $request->no_berita_peninjauan,
           'tgl_berita_peninjauan' => $dateMasehi2,
           'no_berita_acara'       => $request->no_berita_acara,
           'tgl_berita_acara'      => $dateMasehi3,
      ...
      $clientId="c7b3886d-6922-4e57-8c83-62c3098acf1c";
        ...
        SuratSirtu::create([
           ...
           'jangka_waktu'          => $request->jangka_waktu,
           'nomor_izin_lama'       => $request->nomor_izin_lama,
           'tgl_izin_lama'         => $request->tgl_izin_lama,
           'masa_izin_lama'        => $request->masa_izin_lama,
           'no_berita_peninjauan'  => $request->no_berita_peninjauan,
           'tgl_berita_peninjauan' => $request->tgl_berita_peninjauan,
           'no_berita_acara'       => $request->no_berita_acara,
           'tgl_berita_acara'      => $request->tgl_berita_acara,
           'type'                  => 'Perpanjangan Izin Galian-C',
           'word'                  => $filename,
           'pdf'                   => $pdfName
        ]);
  

        $this->bapPerpanjanganSirtu($request);
    ...
    public function bapPerpanjanganSirtu(Request $request){
        ...
        $fileName = 'word/'.time().'-'.$request->nama.'-'.'BAP-Perpanjangan-Galian-C'.'.'.'docx';
  
        $template->saveAs($fileName);
  
        $filename = time().'-'.$request->nama.'-'.'BAP-Perpanjangan-Galian-C'.'.'.'docx';
        ...
        $aspose = new \Aspose\Words\Model\Requests\ConvertDocumentRequest($file, $format,null);
        $result = $wordsApi->ConvertDocument($aspose);	
        copy($result->getPathName(),'pdf/'.time().'-'.$request->nama.'-'.'BAP-Perpanjangan-Galian-C'.'.'.'pdf');
        print_r($result->getPathName());
        $pdfName = time().'-'.$request->nama.'-'.'BAP-Perpanjangan-Galian-C'.'.'.'pdf';
  
        BAP::create([
           'no_berita_acara'       => $request->no_berita_acara,
           'tgl_berita_acara'      => $request->tgl_berita_acara,
           'nama_pt'               => $request->nama_pt,
           'type'                  => 'BAP Perpanjangan Izin Galian-C',
           'word_bap'              => $filename,
           'pdf_bap'               => $pdfName
        ]);
    ...
    public function show(){
        ...
        $data=SuratSirtu::all();
        return view('arsipsirtu',compact('data'));
    }
 
    public function showDetail($id){
 
        $data = SuratSirtu::find($id);
       $datas = BAP::find($id);
       $d = SuratSirtu::where('id', $id)->value('type');
 
       if($id){
          if($d == 'Perpanjangan Izin Galian-C'){
             return view('detailperpanjangansirtu', compact('data', 'datas'));
          } else {
             return view('detailizinsirtu', compact('data', 'datas'));
          }
       }
    }
    ...
    public function search(Request $request){
       ...
       $data = SuratSirtu::where('nama', 'LIKE', '%'.$request->search.'%' )
       ...
       foreach($data as $d){
          ...
          '<tr>
             ...
             <td>'.$d->nama_pt.'</td>
             <td>'.$d->type.'</td>
             <td>'.'<a href="/detailsuratsirtu'.$d->id.'" class="text-primary">'.'Detail'.'</a>'.'</td>
          </tr>';
